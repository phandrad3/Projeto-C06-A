...
public class Estoque {
    ...
    private static final Map<Integer, Produto> produtosMap = new HashMap<>(); // New map to store products
    ...
    public static void adicionarEstoque(Produto produto, int quantidade) {
        ...
        produtosMap.put(idProduto, produto); // Store the product in the map
    ...
    public static boolean atualizarEstoque(Produto produto, int novaQuantidade) {
        ...
        System.out.println("Estoque do produto '" + produto.getNome() + "' (ID: " + idProduto + ") atualizado para " + novaQuantidade + " unidade(s).");
        return true;
    }
